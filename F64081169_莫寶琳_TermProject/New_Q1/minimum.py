...
import random 
import math
from service.function_Min import UPDATE,CREATE_BLOCK_AND_BASE_STATION,CREATE_CAR
...
pygame.init()
pygame.display.set_caption("Q1 Minimum")


if __name__ == "__main__":
    ###開始計時
    print("P_TRANSMIT(dB):",PMin_TRANSMIT,"  Pmin(dB):",P_THREASHOLD)
